    ...
    <div className="App">
      <div className="image">
        <div className="bannerContent">
          <span className="heading">Cryptocurrency Tracker</span>
      ...
      <div className="coin-app">
        ...
        <div className="abc">
          <tr className="coin-row">
            <th className="coin">Coins</th>
            <th className="coin-price">Price</th>
            <th className="coin-volume">Volume</th>
            <th className="coin-percent">Price Change</th>
            <th className="coin-marketcap">Mht Cap</th>
          </tr>
        </div>
        <>
          <div className="coinsInfo">
